...
$(function () {
    ...
    function getTpl() {
        ...
        const xf_rest_time = {
            restTime: [
                ...
                { work: '9:00 上班', img: 'assets/upload/study.png' },
        ...
        const xf_site = {
            siteInfo: [
                { name: '龙年大吉', links: 'https://qcactivity.github.io/Happy-New-Year/', pic: 'assets/upload/2024新年快乐.jpg' },
        ...
        const xf_friend = {
            friendInfo: [
           //   { qq: '3028885917', links: 'https://www.xfabe.com/', name: 'Qc', sig: '暂无' },
                { qq: '1526656461', links: 'JavaScript:;', name: '✏️', sig: '暂无' },
            ]
        }
    ...
    let webTime = new Date('2024-01-15') // 这里修改建站时间
